//Each button must be individually labeled.  Any duplicates will not work.
 ;(function($) {
        ...
        $(function() {
            ...
            $('#my-button6').on('click', function(e) {
            ...
            $('#my-button7').on('click', function(e) {
            ...
            $('#my-button8').on('click', function(e) {
            ...
            $('#my-button9').on('click', function(e) {
